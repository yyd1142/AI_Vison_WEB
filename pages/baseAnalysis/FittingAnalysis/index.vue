      ...
      <div class="fittingAnalysis" slot="page">
        ...
        <div class="data-detail-wrap">
          ...
          <div class="detail-item detail-center">
            <div class="detail-padding my-box-shadow">
              <DataDetailTitle :title="`${languageDatas.MaleToFemaleRatioFitting[language]}`"></DataDetailTitle>
          ...
          <div class="detail-item detail-right">
            <div class="detail-padding my-box-shadow">
              <DataDetailTitle :title="`${languageDatas.AgeDistributionFitting[language]}`"></DataDetailTitle>
...
<script src="@js/fittingAnalysis.js"></script>

<style lang="less" src="@style/fittingAnalysis.less"></style>
